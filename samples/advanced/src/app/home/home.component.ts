...
@Component({
  ...
  `,
    styles: [``],
    standalone: true,
    imports: [UpboatsComponent, AuthComponent, AppCheckComponent, DatabaseComponent, FirestoreComponent, MessagingComponent, RemoteConfigComponent, StorageComponent, FunctionsComponent]
})
